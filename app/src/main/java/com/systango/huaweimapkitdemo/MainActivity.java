...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapsInitializer.setApiKey("CgB6e3x9M4kVO6PgHcu8SnAOVjEnql4rMWRUhyesI5bd1yXVKw2dwmW9DliQ7R/ecoJVheSAQXxpmRLKPsNmX9xU");
    ...
    public void onMapReady(HuaweiMap map) {
        ...
        CameraPosition build = new CameraPosition.Builder().target(romaLatLng).zoom(5).build();
